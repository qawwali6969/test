...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = """👋 Привет! Помогаю придумывать идеи для контента.

Просто напиши мне, что нужно:
• Ниша (фитнес, бизнес, образование...)
• Цель (привлечь аудиторию, обучить, продать...)
• Формат (пост ВК, Instagram, статья, видео...)

Например:
"Нужны идеи для фитнес-блога в Инстаграм, хочу привлечь новую аудиторию"

Накидаю тебе 5 вариантов, выберешь что понравится — сделаю готовый пост.

Команды:
/new - новый запрос
/history - сохранённые посты
/help - справка"""
